# VALDR / MASTER TECHNICAL SPECIFICATION v0.2.5

**Desktop, cross-platform distribution and Testnet productization**  
**Date:** 24 September 2026  
**Status:** active master implementation baseline  
**Previous baseline:** `docs/VALDR_Master_TZ_v0.2.4.md`  
**Active branch:** `valdr-v0.2`

> v0.2.5 replaces v0.2.4 as the current implementation baseline. v0.2, v0.2.1, v0.2.2, v0.2.3 and v0.2.4 remain immutable historical specifications. Frozen legacy v0.1 remains `release/valdr-devnet-v0.1`.
...
- v0.2.5 is the active master specification after its commit;
