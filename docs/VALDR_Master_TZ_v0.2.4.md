# VALDR / MASTER TECHNICAL SPECIFICATION v0.2.4

**Desktop, cross-platform distribution and Testnet productization**  
**Date:** 24 September 2026  
**Status:** active master implementation baseline  
**Previous baseline:** `docs/VALDR_Master_TZ_v0.2.3.md`  
**Active branch:** `valdr-v0.2`

> v0.2.4 replaces v0.2.3 as the current implementation baseline. v0.2, v0.2.1, v0.2.2 and v0.2.3 remain immutable historical specifications. Frozen legacy v0.1 remains `release/valdr-devnet-v0.1`.
...
- v0.2.4 is the active master specification after its commit;
