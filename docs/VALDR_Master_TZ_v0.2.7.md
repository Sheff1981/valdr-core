# VALDR / MASTER TECHNICAL SPECIFICATION v0.2.7

**Desktop, cross-platform distribution and Testnet productization**  
**Date:** 25 September 2026  
**Status:** active master implementation baseline  
**Previous baseline:** `docs/VALDR_Master_TZ_v0.2.6.md`  
**Active branch:** `valdr-v0.2`

> v0.2.7 replaces v0.2.6 as the current implementation baseline. v0.2 through v0.2.6 remain immutable historical specifications. Frozen legacy v0.1 remains `release/valdr-devnet-v0.1`.
...
| 13 | Cross-platform installers + release pipeline | in progress / development-only release plumbing; public release blocked by Stage 12 acceptance |
...
- v0.2.7 is the active master specification after its commit;
